...
const tourSchema = new mongoose.Schema({
  ...
  maxGroupSize: {
    type: Number,
    required: [true, 'A tour requires a group size']
  },
  difficulty: {
    type: String,
    ...
    enum: {
      ...
      message: 'Tour difficulty valid values are: easy, medium, or difficult'
    }
  },
  ratingsAverage: {
    type: Number,
    default: 4.5,
    min: [1, 'A tour rating must be greater than or equal to 1'],
